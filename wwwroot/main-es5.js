(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAuthAuthComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<mat-card>\n  <mat-card-title>\n    Введите свой логин и пароль\n  </mat-card-title>\n  <mat-card-content>\n    <mat-form-field>\n        <input type=\"text\" matInput placeholder=\"Ваш логин\" [(ngModel)]=\"login\">\n    </mat-form-field>\n    <mat-form-field>\n        <input type=\"password\" matInput placeholder=\"Ваш пароль\" [(ngModel)]=\"password\">\n    </mat-form-field>\n  </mat-card-content>\n  <mat-card-actions>\n    <button (click)=\"authUser()\" mat-raised-button color=\"primary\">Войти</button>\n  </mat-card-actions>\n</mat-card>\n";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"], _auth_auth_component__WEBPACK_IMPORTED_MODULE_11__["AuthComponent"], _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_12__["PageNotFoundComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_2__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_7__["MatSnackBar"]],
      providers: [{
  ...
  function srcAppAuthAuthComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AuthComponent = class AuthComponent {
      ...
      authUser() {
        try {
          if (!this.login) {
            this.snackBar.open('Укажите логин!', 'OK', {
              duration: 3000
            });
            return;
          }
          ...
          if (!this.password) {
            this.snackBar.open('Укажите пароль!', 'OK', {
              duration: 3000
            });
            return;
          }
          ...
          this.authService.checkCredentials(user).subscribe(data => {}, error => {
            if (error.status === 401) {
              this.snackBar.open("".concat(error.status, " \u0421\u0435\u0440\u0432\u0435\u0440 \u0432\u0435\u0440\u043D\u0443\u043B \u043E\u0448\u0438\u0431\u043A\u0443!"), 'OK', {
                duration: 3000
              });
            } else {
              this.snackBar.open("".concat(error.status, " \u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u043B\u043E\u0433\u0438\u043D \u0438\u043B\u0438 \u043F\u0430\u0440\u043E\u043B\u044C!"), 'OK', {
                duration: 3000
              });
            }
          });
        } catch (error) {
          this.snackBar.open('Не удаётся проверить логин и пароль из-за непредвиденной ошибки!', 'OK', {
            duration: 3000
          });
        }
      }
    ...
    let AuthService = class AuthService {
      ...
      checkCredentials(user) {
        ...
        if (!_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].production) {
          url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].devApiUrl + url;
        }
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const environment = {
      production: false,
      devApiUrl: 'https://localhost:44384'
    };
    /*
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Projects\CRM\ClientApplication\crm-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
