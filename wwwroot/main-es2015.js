...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        ...
        providers: [{ provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _auth_auth_interceptor__WEBPACK_IMPORTED_MODULE_8__["AuthInterceptor"], multi: true }],
...
let AuthComponent = class AuthComponent {
    ...
    authUser() {
        try {
            ...
            const user = { login: this.login, password: this.password, name: null };
...
module.exports = __webpack_require__(/*! C:\Projects\CRM\ClientApplication\crm-app\src\main.ts */"./src/main.ts");
